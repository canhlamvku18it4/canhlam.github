...
import com.example.green_social.Apdaters.PostsAdapter;
...
import com.example.green_social.Models.User;
        ...
        StringRequest request = new StringRequest(Request.Method.GET, Constant.POSTS, response -> {
            ...
            try {
                ...
                if (object.getBoolean("success")){
                    JSONArray jsonArray = new JSONArray(object.getString("posts"));
